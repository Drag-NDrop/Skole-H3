...
@Component({
  selector: 'app-fdm-ev-table-material',
  standalone: true,
  imports: [CommonModule, MatTableModule],
  templateUrl: './fdm-ev-table-material.component.html',
  styleUrl: './fdm-ev-table-material.component.css'
})

export class FDMEVTableMaterialComponent {

  ///private dataSource = new Array<ECarsData>();
  displayedColumns: string[] = ['rank', 'model', 'quantity', 'changeQuantityPercent'];
  dataSource: Observable<ECarsData[]> = new Observable<ECarsData[]>();
  ...
  ngOnInit(){
    this.dataSource = new Observable<Array<ECarsData>>((publisher)=>{
