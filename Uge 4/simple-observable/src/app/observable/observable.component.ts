...
// The data interface for the observable
...
export class ObservableComponent {
  ...
  // Instantiate the datasource observable
  ...
  // Create a subscriber for the observable
  subscriber$?: Observable<Array<ECarsData>>

  // On Init, set the observable to the data source
  ngOnInit(){
